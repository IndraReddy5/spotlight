        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="container pt-5">
            ...
            <div class="row g-0 row-cols-auto" v-if="albums">
              <AlbumComponent :AlbumName="value.album_name" :AlbumCreator="value.artists" :imageSource="value.cover_image" :AlbumID="key" v-for="value,key,index in albums"></AlbumComponent>
            </div>
